...
class HomeFeatureScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final bool hasBottomNav = currentIndex != null;
    final double bodyBottomPadding = hasBottomNav ? 136 : AppSpacing.spacing24;

    return Scaffold(
      extendBody: hasBottomNav,
      extendBodyBehindAppBar: hasBottomNav,
                  ...
                  children: <Widget>[
                    ...
                    SizedBox(
                      ...
                      child: FilledButton(
                        ...
                        child: Text(
                          LocalizationConstants.homeFeatureBackToHomeKey.tr(),
                        ),
                      ),
                    ),
                  ],
