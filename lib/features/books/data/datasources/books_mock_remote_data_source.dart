  ...
  Future<List<Book>> fetchBooks() async {
    ...
    return const <Book>[
      ...
      Book(
          id: '2',
          title: 'Global English',
          subtitle: 'Course Book 11',
          price: '13.5\$',
          format: BookFormat.ebook,
          coverAsset: 'assets/images/books/global_english_11.png'),
      Book(
          id: '3',
          title: 'Global English',
          subtitle: 'Course Book 10',
          price: '15\$',
          format: BookFormat.free,
          coverAsset: 'assets/images/books/global_english_10.png'),
      Book(
          id: '4',
          title: 'Global English',
          subtitle: 'Learner’s Book 8',
          price: '9\$',
          format: BookFormat.used,
          coverAsset: 'assets/images/books/learners_book_8.png'),
      Book(
          id: '5',
          title: 'Global English',
          subtitle: 'Course Book 11',
