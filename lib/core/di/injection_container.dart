...
import '../../features/auth/presentation/logic/auth_journey_cubit.dart';
import '../../features/auth/presentation/logic/auth_permission_cubit.dart';
import '../../features/auth/presentation/logic/auth_recovery_cubit.dart';
import '../../features/auth/presentation/logic/change_password_cubit.dart';
import '../../features/auth/presentation/logic/auth_registration_cubit.dart';
import '../../features/onboarding/presentation/logic/onboarding_bloc.dart';
...
import '../../features/profile/presentation/logic/profile_location_cubit.dart';
...
import '../../features/libraries/data/data_sources/libraries_remote_data_source.dart';
...
import '../../features/libraries/presentation/logic/libraries_cubit.dart';
import '../../features/libraries/data/data_sources/library_details_remote_data_source.dart';
...
import '../../features/local_explorer/data/data_sources/local/local_explorer_platform_data_source.dart';
import '../../features/local_explorer/data/data_sources/local/local_file_system_data_source.dart';
import '../../features/local_explorer/data/data_sources/local/local_file_system_data_source_factory.dart';
...
import '../../features/pdf_reader/data/data_sources/local/pdf_note_data_source.dart';
import '../../features/pdf_reader/data/data_sources/local/pdf_reader_local_state_data_source.dart';
...
import '../../features/pdf_reader/presentation/logic/pdf_reader_bloc.dart';
...
import '../../features/book_assistant/data/data_sources/book_assistant_remote_data_source.dart';
...
import '../../features/book_assistant/presentation/logic/book_assistant_bloc.dart';
import '../../features/settings/data/data_sources/library_registration_remote_data_source.dart';
...
void registerFeatureDependencies() {
  ...
  if (!sl.isRegistered<OrdersRemoteDataSource>()) {
    ...
    sl.registerLazySingleton<ConfirmCheckoutUseCase>(
      () => ConfirmCheckoutUseCase(sl<OrdersRepository>()),
    );
  ...
  if (!sl.isRegistered<CheckoutCubit>()) {
    sl.registerFactory<CheckoutCubit>(
      () => CheckoutCubit(
        ...
        confirmCheckout: sl<ConfirmCheckoutUseCase>(),
