...
abstract class Failure extends Equatable {
  ...
  @override
  String toString() => '$runtimeType(code: $code, title: $title, message: $message)';
}
...
final class OperationFailedFailure extends _BaseFailure {
  const OperationFailedFailure({String code = ErrorCodes.operationFailedRetry, String? message})
      : super(
          code: code,
...
final class NetworkFailure extends _BaseFailure {
  const NetworkFailure({String code = ErrorCodes.networkErrorRetry, String? message})
      : super(
          code: code,
          title: 'Network Error',
...
final class BadRequestFailure extends _BaseFailure {
  const BadRequestFailure({String code = ErrorCodes.badRequest, String? message})
      : super(
          code: code,
          title: 'Bad Request',
...
final class UnauthorizedFailure extends _BaseFailure {
  const UnauthorizedFailure({String code = ErrorCodes.unauthorized, String? message})
      : super(
          code: code,
          title: 'Unauthorized',
...
final class NotFoundFailure extends _BaseFailure {
  const NotFoundFailure({String code = ErrorCodes.resourceNotFound, String? message})
      : super(
          code: code,
          title: 'Not Found',
...
final class ValidationFailure extends _BaseFailure {
  const ValidationFailure({String code = ErrorCodes.validationFailed, String? message})
      : super(
          code: code,
...
final class ConflictFailure extends _BaseFailure {
  const ConflictFailure({String code = ErrorCodes.conflict, String? message})
      : super(
          code: code,
          title: 'Conflict',
...
final class TooManyRequestsFailure extends _BaseFailure {
  const TooManyRequestsFailure({String? message})
      : super(
          ...
          message: message ?? 'Too many requests were sent. Please try again later.',
        );
}

final class PaymentRequiredFailure extends _BaseFailure {
  const PaymentRequiredFailure({String code = ErrorCodes.paymentRequired, String? message})
      : super(
          code: code,
...
final class InternalFailure extends _BaseFailure {
  const InternalFailure({String code = ErrorCodes.internalServerError, String? message})
      : super(
          code: code,
